...
The aim of this paper is to evaluate the effiency of DLV in the search for adversarial examples. This can be achieved by understanding how the configuration of the tool and the networks impacts the outputs of DLV. The purpose is to understand how each parameter works. 
