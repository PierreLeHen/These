...
\emph{Deep neural networks} are known to generalize well over unseen data, which makes them perfect models to deal with image classification. Deep learning represents a solution to various complex tasks for real-worlds problems.
